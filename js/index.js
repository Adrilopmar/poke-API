...
const findPokemon = async()=>{
  ...
  pokeFilter = pokeFilter.filter(poke=> poke.name.includes(inputToSearch.trim()))
...
document.querySelector('.modal-background').addEventListener('click',()=>{ document.getElementById('pokeModal').classList.remove('is-active')})
document.querySelector('.modal-close').addEventListener('click',()=>{ document.getElementById('pokeModal').classList.remove('is-active')})